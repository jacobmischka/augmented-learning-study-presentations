...
![Pineapple](assets/fruits/pineapple.jpg)

## Pineapple

_Ananas comosus_

Little known about origin of domestication, thought to come originally from southern Brazil and Paraguay. Encountered by Columbus in 1493 on Guadeloupe.

In the wild, pollinated primarily by hummingbirds

<img className="qrcode" alt="Pineapple QR code" src="assets/qrcodes/fruits/pineapple.png" />
