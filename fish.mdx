...
Can be recognized by their deep blue bodies with black palettes and yellow tails (or by thinking of Dory)
...
![Clark's anemonefish](assets/fish/clarks-anemonefish.jpg)

## Clark's anemonefish

_Amphiprion clarkii_

Can be recognized by their two vibrant vertical white bands on a dark and orange body

Name honors Scottish engraver John Heaviside Clark

```notes
Clark provided illustrations for Bennett's A Selection from the most remarkable and interesting Fishes found on the Coast of Ceylon, from drawings made in the Southern part of that Island.
```

<img className="qrcode" alt="Clark's anemonefish QR code" src="assets/qrcodes/fish/11-clarks-anemonefish.png" />
...
Like previous, are immune to sea anemone's poison and use them as nests
